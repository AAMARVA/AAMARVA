          ...
          <div className="max-w-xl mx-auto space-y-5">
            ...
            {isAuthenticated && user ? (
              <div className="p-5 bg-[#141414] text-white border-2 border-[#141414] text-center space-y-3 font-mono">
                ...
                <button
                  onClick={logout}
                  className="mt-3 px-3 py-1.5 bg-white text-[#141414] font-black text-xs uppercase border border-white hover:bg-[#E4E3E0]"
                >
                  Sign Out Session
                </button>
              </div>
              ...
              <form onSubmit={handleLoginSubmit} className="space-y-4 font-mono">
                {loginError && (
                  <div className="p-2.5 bg-red-100 border-2 border-red-600 text-red-900 text-xs">
                    {loginError}
                  </div>
                )}
